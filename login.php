...
if(isset($_POST["login"])){
  ...
  if($isValid){
    ...
    $password_hash_from_db = '$2y$10$laJMwVd4rID.FeVULfmfXeZ3ec1ZU8eRZfoo.AZRQUJNfioDVzHr2';//placeholder, you can copy/paste a hash generated from sample_reg.php if you want to test it

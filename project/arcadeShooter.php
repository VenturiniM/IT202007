...
function menu() {
  ...
  context.fillText('Up/Down or W/S to move, Spacebar to shoot.', canvas.width / 2, (canvas.height / 4) * 3);
  context.font = '16px Arial';  
  context.fillText('Press P to pause and unpause.', canvas.width / 2, canvas.height /1.15);
...
function endGame() {
  ...
  context.fillText('Final Score: ' + score, canvas.width / 2, (canvas.height / 2)+35);
  context.font = '18px Arial';
  context.fillText('Press R to Play Again', canvas.width / 2, (canvas.height / 2)+140);
 }
...
function sendScore(){
	...
	xhttp.open("POST", "send_game_scores.php", true);
	xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	xhttp.send("sendscore="+ myscore);
